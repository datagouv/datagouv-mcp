...
> [!IMPORTANT]
> If you are a developper, read first the documentation of the APIs that power this MCP's tools : [Main](https://guides.data.gouv.fr/api-de-data.gouv.fr/prise-en-main) | [Tabular](https://www.data.gouv.fr/dataservices/api-tabulaire-data-gouv-fr-beta) | [Metrics](https://metric-api.data.gouv.fr/api/doc#/). Our APIs will help you write code that is more robust, reproducible, and sustainable, by preventing unnecessary usages of LLMs.

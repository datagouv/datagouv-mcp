...
Model Context Protocol (MCP) server that allows AI chatbots to search, explore, analyze, and publish datasets on [data.gouv.fr](https://www.data.gouv.fr), the French national Open Data platform, directly through conversation.

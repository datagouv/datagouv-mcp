...
from tools.get_metrics import (
    register_get_metrics_interactive_tool,
...
def register_tools(mcp: FastMCP) -> None:
    ...
    register_search_datasets_interactive_tool(mcp)
    register_search_organizations_tool(mcp)
    register_search_organizations_interactive_tool(mcp)
    register_search_dataservices_tool(mcp)
    register_search_dataservices_interactive_tool(mcp)
    ...
    register_query_resource_data_interactive_tool(mcp)
    register_get_dataset_info_tool(mcp)
    register_list_dataset_resources_tool(mcp)
    register_list_dataset_resources_interactive_tool(mcp)
    register_get_resource_info_tool(mcp)
    register_get_metrics_tool(mcp)
    register_get_metrics_interactive_tool(mcp)
